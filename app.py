...
client = OpenAI(api_key="sk-temp-demo-key")
    ...
    if st.button("Generate Recommendations"):
        if selected_prompt_text:
            with st.spinner("Generating recommendations using GPT-4..."):
                try:
                    rec_prompt = """You are a senior procurement advisor preparing an executive briefing.
...
**Option 2: ...
...
Respond in clean, professional markdown. Do not include an introduction or conclusion."""
